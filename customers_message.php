<?php session_start(); require_once('customers_message_view.php'); ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<body>
       ...
       <div class="wrapper">
       		<nav  class= 'cyan lighten-1'>
                        <div class="nav-wrapper">
                          ...
                          <ul class="right hide-on-med-and-down">
                            ...
                            <li><a href="viewmessage.php">View Message</a></li>
                             ...
                             <li><a href="customers_message.php">Customers message </a></li>
                    ...
                    <div class="container">
                       		<h3 class="center-align">Customer Messages</h3>
                            <?php echo $result; ?>
                    	...
                    	<div class="row">
                            ...
                            <div class="card blue-grey darken-1">
                                <div class="card-content white-text">
                                  <span class="card-title">Sender:<?php echo $row['name']; ?></span>
